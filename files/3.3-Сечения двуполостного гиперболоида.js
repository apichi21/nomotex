...
function initDescr() {
    ...
    descr += '<button onclick="changeToParalLinesIm();">Пара мнимых параллельных прямых</button><br>';
