...
function initDescr() {
    ...
    descr += '<p>$F$ - фокус параболы.</p>';
    descr += '<label><input type="checkbox" checked onchange="isShowC = this.checked; initBuffers();"> $c$ - расстояние до фокуса.</label>';
    var tIS = 5;
    ...
    $("Title").html("Каноническое уравнение параболы");
}
var isShowC = true;
