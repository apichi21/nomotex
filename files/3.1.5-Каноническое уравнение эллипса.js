...
function initDescr() {
    ...
    descr += '$b$ - малая полуось эллипса,<br>';
    ...
    $("Title").html("Каноническое уравнение эллипса");
}
var a;
var b;
var isShowC = true;
...
function initData() {
    ...
    if (isShowC) {
        primitives.push({class:"dashline", text: "c", pos: a>=b?'lt':'rb', arr0:[0,0,0], arr1:focus2, rad:arrRad*1.2, color:[0.0, 0.6, 1.0, 1.0]});
    }
