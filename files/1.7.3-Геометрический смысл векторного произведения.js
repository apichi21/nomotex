...
function initDescr() {
    ...
    parametershtml += "$S = |\\vec a\\times\\vec b| = $<input type='text' id='C' size='"+textInputSize+"'readonly> <br/>";
    ...
    $("#description").html("Длина векторного произведения векторов $\\vec a$ и $\\vec b$ равна площади $S$ параллелограмма, построенного на этих векторах.");
...
function initData() {
    ...
    primitives.push({class:"plane", text: "", arr0:points[0].coord1, arr1:points[1].coord1, arr2:sum_ab, arr3:points[2].coord1, color:[0.5, 0.5, 1.0, 0.35]});
