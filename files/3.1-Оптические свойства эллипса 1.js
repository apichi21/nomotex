...
function initData() {
    ...
    if (arrPoint != 0) {
        ...
        if (arrPoint == points[4].coord1) {
            ...
            paramOfPoint[0] = Math.acos(point4vec[0]);
            if (point4vec[1]<0) paramOfPoint[0] *= -1;
        }
    }
    a = Math.abs(points[0].coord1[0]);
    b = Math.abs(points[1].coord1[1]);
    ...
    vec3.set([a*Math.cos(paramOfPoint[0]), b*Math.sin(paramOfPoint[0]), 0.0], pointM);
    ...
    var vTangent1 = [-vsum12[1]*2*a, vsum12[0]*2*a, 0];
    var vTangent2 = [vsum12[1]*2*a, -vsum12[0]*2*a, 0];
    var pTangent1 = [];
    var pTangent2 = [];
