...
function initDescr() {
    var descr = "";
        descr += "<p>Система уравнений вида $\\left\\{\\begin{matrix} \
  A_1x+B_1y+C_1z+D_1=0 \\\\ \
  A_2x+B_2y+C_2z+D_2=0 \
\\end{matrix}\\right.$ называется общими уравнениями прямой в пространстве.</p>";
    ...
    $("Title").html("Общие уравнения прямой в пространстве");
}
var abcd1 = [2,1,2,2];
var abcd2 = [0,2,1,-1];
...
function initData() {
    ...
    var planepoint3 = [];
    var planepoint4 = [];
    createPlane(pointM10,pointM11,pointM12,planepoint1,planepoint2,planepoint3,planepoint4);
    ...
    var planepoint3 = [];
    var planepoint4 = [];
    createPlane(pointM20,pointM21,pointM22,planepoint1,planepoint2,planepoint3,planepoint4);
