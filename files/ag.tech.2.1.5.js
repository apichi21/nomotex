...
function initPoints() {
    points = [];
    points.push({coord1: vec3.create([1.5, 1, -1]), movable: "free"});
    points.push({coord1: vec3.create([-2, -1.8, -1]), movable: "plane", vector:[0,1,0]});
    points.push({coord1: vec3.create([3, -1.8, 1]), movable: "plane", vector:[0,1,0]});
}
var meshPlane = {}, meshRadar = {};
function initDescr() {
    var descr = "Координаты самолёта в 2-х системах координат, связанных с положением двух РЛС.";
...
var te5 = katex.renderToString("O'");
var te6 = katex.renderToString("y'");
var te7 = katex.renderToString("z'");
var te8 = katex.renderToString("x'");
var te9 = katex.renderToString("\\vec a");
var te0 = katex.renderToString("\\vec a'");
...
function initData() {
    ...
    primitives.push({class:"point", text: "", arr0:points[0].coord1, offset:true, rad:4, color:[0.0, 0.0, 1.0, 1.0]});
    primitives.push({class:"point", text: "", arr0:points[1].coord1, offset:true, rad:4, color:[1.0, 0.0, 0.0, 1.0]});
    primitives.push({class:"point", text: "", arr0:points[2].coord1, offset:true, rad:4, color:[1.0, 0.0, 0.0, 1.0]});
    var arrlen = 1;
    var center = points[1].coord1;
    ...
    primitives.push({class:"arrow", text: "", arr0:center, arr1:[center[0],center[1]+arrlen,center[2]], offset:true, rad:1.5, color:[0.3, 0.3, 0.3, 1.0]});
    primitives.push({class:"arrow", text: "", arr0:center, arr1:[center[0],center[1],center[2]+arrlen], offset:true, rad:1.5, color:[0.3, 0.3, 0.3, 1.0]});
    primitives.push({class:"text", text: te5, arr0:center, pos:'rt'});
    primitives.push({class:"text", text: te6, arr0:[center[0]+arrlen,center[1],center[2]]});
    primitives.push({class:"text", text: te7, arr0:[center[0],center[1]+arrlen,center[2]]});
    primitives.push({class:"text", text: te8, arr0:[center[0],center[1],center[2]+arrlen]});

    primitives.push({class:"arrow", text: "", arr0:points[1].coord1, arr1:points[2].coord1, offset:true, rad:2, color:[0.8, 0.0, 0.0, 1.0]});
    primitives.push({class:"arrow", text: te9, arr0:points[1].coord1, arr1:points[0].coord1, offset:true, rad:2, color:[0.0, 1.0, 0.5, 1.0]});
    primitives.push({class:"arrow", text: te0, arr0:points[2].coord1, arr1:points[0].coord1, offset:true, rad:2, color:[0.0, 0.5, 1.0, 1.0]});
    var plen = 7;
    var pz = -3;
