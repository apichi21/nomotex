...
function initDescr() {
    ...
    descr += 'Вектор суммарных сил, действующих на ЛА:$$\\vec F_1=\\vec P+\\vec G$$';
    descr += '$$\\vec F=\\vec F_1+\\vec R_\\text{а}$$</br>';
...
function initData() {
    ...
    primitives.push({class:"dashline", text: "", offset:true, arr0:vectorG, arr1:sumPG, rad:projRad, color:GColor});
    primitives.push({class:"dashline", text: "", offset:true, arr0:vectorP, arr1:sumPG, rad:projRad, color:RXColor});
    primitives.push({class:"arrow", text: katex.renderToString("\\vec F_1"), offset:true, arr0:center, arr1:sumPG, rad:GRad, color:RYColor});
    primitives.push({class:"dashline", text: "", offset:true, arr0:sumPG, arr1:sumPGR, rad:projRad, color:RColor});
    primitives.push({class:"dashline", text: "", offset:true, arr0:vectorR, arr1:sumPGR, rad:projRad, color:RYColor});
    primitives.push({class:"arrow", text: katex.renderToString("\\vec F"), offset:true, arr0:center, arr1:sumPGR, rad:GRad, color:RZColor});
