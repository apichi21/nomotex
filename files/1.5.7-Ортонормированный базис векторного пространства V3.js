...
function initDescr() {
    var descr = '';
    descr += "$\\vec i, \\vec j, \\vec k$ - ортонормированный базис пространства $V^3$<br>";
    descr += "$\\alpha_1, \\alpha_2, \\alpha_3$ - координаты вектора в базисе<br>";
    descr += "$\\vec a=\\alpha_1\\vec i+\\alpha_2\\vec j+\\alpha_3\\vec k$";
...
var katveca1al = katex.renderToString("\\alpha_1\\vec i");
var katveca2al = katex.renderToString("\\alpha_2\\vec j");
var katveca3al = katex.renderToString("\\alpha_3\\vec k");
