...
function initDescr() {
    ...
    parametershtml += "$(\\vec a\\times\\vec b)\\cdot\\vec c = $<input type='text' id='C' size='"+textInputSize+"' readonly> <br/>";
    ...
    $("#description").html("Смешаное произведение векторов $\\vec a$, $\\vec b$ и $\\vec c$."); 
