...
function initDescr() {
    ...
    var conditions = "$а)$ Определить тип кривой по заданному уравнению вида \\begin{equation} Ax^2+2Вxy+Cy^2+2Dx+2Ey+F=0, \\end{equation} где $A, B, C, D, E, F$ - некоторые действительные числа, а также определить тип кривой для частного случая из пункта $б)$.<br> \
      $б)$ Привести кривую к каноническому виду и записать название кривой для случая, когда $A=1$, $B=0$, $C=0$, $D=4$, $E=0$, $F=25$, т.е. уравнение $(1)$ принимает вид: \\begin{equation*}  x^2 + 8 x + 25 = 0\\end{equation*}\
    ...
    if (showAlgorithm) {
      ...
      \\begin{equation*} ( x^2 + 2 \\cdot 4 \\cdot x + 16 )-16+25=0; \\end{equation*}\
      \\begin{equation*} ( x + 4 )^2 - 16 +25=0; \\end{equation*}\
      \\begin{equation*} ( x + 4 )^2 + 9 =0;  \\end{equation*}\
      \\begin{equation} ( x + 4 )^2 = -9. \\end{equation} </p>";
      algorithm += "<p class='toggleable'>Сделаем замену координат: \
      \\begin{equation*} x'= x + 4  \\end{equation*}</p>";
      algorithm += "<p class='toggleable'>Тогда уравнение $(2)$ примет вид: \
      \\begin{equation*}  x'^2 = -a^2   \\end{equation*} \
      &mdash; каноническое уравнение пары мнимых параллельных прямых, где $a=3$. </p>";
      algorithm += "<p class='toggleable'>Следовательно, уравнение $(2)$ является уравнением пары мнимых параллельных прямых. </p>";
    ...
    values[0].push([1, 0, 0, 8, 0, 25]);
    values[0].push([4, 0, 0, -20, 0, 29]);
    values[0].push([0, 0, 1, 0, 4, 13]);
