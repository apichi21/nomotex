...
function initDescr() {
    ...
    if (showAlgorithm) {
      ...
      algorithm += "<p class='toggleable'>Рассмотрим случай, когда $A=2$, $B=0$, $C=1$, $D=2$, $E=2$, $F=2$, т.е. уравнение $(1)$ принимает вид: \\begin{equation*} 2 x^2 + y^2 + 4 x+ 4 y + 2 = 0\\end{equation*}</p>";
      ...
      Следовательно, кривая эллиптического типа.</p>";
      ...
      \\begin{equation*} 2(x^2 + 2x + 1 -1) + (y^2 + 4y + 4-4)+2=0; \\end{equation*}\
      \\begin{equation*} 2(x+1)^2 + (y+2)^2 -2-4+2=0; \\end{equation*}\
      \\begin{equation*} 2(x+1)^2 + (y+2)^2 = 4; \\end{equation*}\
      \\begin{equation} \\frac{(x+1)^2}{2} + \\frac{(y+2)^2}{4} = 1. \\end{equation} </p>";
      algorithm += "<p class='toggleable'>Сделаем замену координат: \
      \\begin{equation*} \\begin{cases} x'=y+2 \\\\ y'=x+1 \\end{cases} \\end{equation*}</p>";
      algorithm += "<p class='toggleable'>Тогда уравнение $(2)$ примет вид: \
      \\begin{equation*}  \\frac{x'^2}{a^2}+ \\frac{y'^2}{b^2}=1  \\end{equation*} \
      &mdash; каноническое уравнение эллипса, где $a=2$, $b=\\sqrt{2}$ $(a \\ge b)$. <br> \
      $O'=(-1; -2)$ &mdash; начало канонической системы координат $O'x'y'.$</p>";
      algorithm += "<p class='toggleable'>Следовательно, уравнение $(2)$ является уравнением эллипса с центром симметрии $O'=(-1; -2)$, с большой осью, расположенной параллельно оси $Oy.$</p>";
      algorithm += "<p class='toggleable'>$в)$ Для нахождения координат фокусов вычислим $$c^2 = a^2 - b^2 = 4-2=2.$$</p>";
      ...
      Следовательно,\
      \\begin{equation*} F'_1 = (-\\sqrt{2},0), F'_2 = (\\sqrt{2},0). \\end{equation*}    </p>";
      algorithm += "<p class='toggleable'>А в системе координат $Oxy:$ \
      \\begin{equation*} F_1 = (-1, -2-\\sqrt{2}),  F_2 = (-1, -2-\\sqrt{2}). \\end{equation*} </p>";
      algorithm += "<p class='toggleable'>Эксцентриситет вычислим по формуле $\\varepsilon = \\frac{c}{a}$: \
      \\begin{equation*} \\varepsilon = \\frac{\\sqrt{2}}{2} \\end{equation*}</p>";
    ...
    values[0].push([9, 0, 25, 54, -100, -44]);
    values[0].push([100, 0, -50, 20, 40, 493]);
    values[1].push([50, 0, -25, 20, 30, 93]);
    values[1].push([125, 0, -100, -50, -60, 496]);
    values[1].push([4, 0, -1, -4, 2, 36]);
    values[1].push([1, 0, -4, -4, 56, -152]);
    values[1].push([9, 0, -4, -54, 8, 78]);
    values[1].push([20, 0, -16, 20, 0, 155]);
    values[1].push([1, 0, -6, -24, 120, -420]);
    values[1].push([1, 0, -4, -6, -20, 0]);
    values[1].push([4, 0, 1, 16, 10, 5]);
    values[1].push([16, 0, 9, -32, 18, -119]);
    values[1].push([1, 0, -1, -16, 14, 31]);
    values[1].push([5, 0, 9, 50, -18, 44]);
    values[1].push([4, 0, -9, -8, -18, -6]);
    values[1].push([9, 0, -10, 72, 60, 144]);
    values[2].push([1, 0, -4, 10, -24, -15]);
    values[2].push([1, 0, -4, 4, 12, 11]);
    values[2].push([2, 0, -3, -12, 18, 15]);
    values[2].push([3, 0, 1, -24, 6, 9]);
    values[2].push([25, 0, 100, 10, -120, 36]);
    values[2].push([4, 0, 9, -8, 36, 4]);
    values[2].push([16, 0, -25, -32, -150, 191]);
    values[2].push([1, 0, -5, -14, -30, -41]);
    values[2].push([4, 0, 9, 16, -126, 456]);
    values[2].push([4, 0, 1, 48, 2, 109]);
    values[2].push([9, 0, -4, -90, -40, -235]);
    values[2].push([1, 0, -36, -12, -72, -36]);
    values[2].push([3, 0, 4, 6, -8, -5]);
    values[2].push([25, 0, -4, -50, 16, -91]);
...
function initData() {
    ...
    if (showSolution) {
        ...
        if (A1 == 0 && C1 != 0 && D1 != 0) {
            ...
            var arrXLen = a+2;
            var arrYLen = b+2;
            primitives.push({class:"arrow", text: "x'", ratio: 1, pos: "rb", arr0:[x0-arrXLen, y0, 0], arr1:[x0+arrXLen, y0, 0], rad:1.2, color:[0.5, 0.0, 0.0, 1.0]});
            primitives.push({class:"arrow", text: "y'", ratio: 1, pos: "lt", arr0:[x0, y0-arrYLen, 0], arr1:[x0, y0+arrYLen, 0], rad:1.2, color:[0.5, 0.0, 0.0, 1.0]});
