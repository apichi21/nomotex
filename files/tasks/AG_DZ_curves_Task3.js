...
function initDescr() {
    ...
    if (showAlgorithm) {
      ...
      algorithm += "<p class='toggleable'>Рассмотрим случай, когда $A=4$, $B=0$, $C=-3$, $D=-16$, $E=-6$, $F=52$, т.е. уравнение $(1)$ принимает вид: \\begin{equation*} 4x^2-3y^2-32x-12y+52=0 \\end{equation*}</p>";
      ...
      \\begin{equation*} I = \\begin{vmatrix} 4 & 0 \\\\ 0 & -3 \\end{vmatrix} = -12 \\end{equation*}\
      Следовательно, кривая гиперболического типа.";
      algorithm += "<p class='toggleable'>Для приведения кривой к каноническому виду необходимо выделить полные квадраты, для этого группируем члены, содержащие $x$ и $y$: \
      \\begin{equation*} 4(x^2 - 8x+16-16) - 3(y^2 + 4y +4-4)+52=0; \\end{equation*}\
      \\begin{equation*} 4(x - 4)^2 - 3(y + 2)^2-64+12+52=0; \\end{equation*}\
      \\begin{equation*} 4(x - 4)^2 - 3(y + 2)^2 = 0;  \\end{equation*}\
      \\begin{equation*} y + 2 = \\pm \\frac{2}{\\sqrt{3}}(x-4) \\end{equation*}\
      \\begin{equation} y = \\pm \\frac{2}{\\sqrt{3}}(x-4) -2. \\end{equation}</p>";
      algorithm += "<p class='toggleable'>Сделаем замену координат: \
      \\begin{equation*} \\begin{cases} x'=x-4 \\\\ y'=y+2 \\end{cases} \\end{equation*}</p>";
      algorithm += "<p class='toggleable'>Тогда уравнение $(2)$ примет вид: \
      \\begin{equation*}  \\frac{x'^2}{a^2}- \\frac{y'^2}{b^2}=0  \\end{equation*} \
      \\begin{equation*}  y'= \\pm \\frac{b}{a} x  \\end{equation*} \
      &mdash; каноническое уравнение пары пересекающихся прямых, где $a=\\sqrt{3}$, $b=2$. <br>\
      $O'=(4; -2)$ &mdash; начало канонической системы координат $O'x'y'$. </p>";
      algorithm += "<p class='toggleable'>Следовательно, уравнение $(2)$ является уравнением пары пересекающихся прямых, точка $O'=(4; -2)$ &mdash; точка пересечения прямых. Угловые коэффициенты прямых $\\pm \\frac{b}{a} = \\pm \\frac{2}{\\sqrt{3}}$ </p>";
      algorithm += "<p class='toggleable'>$в)$ отсутствует.</p>";
    ...
    // values[0].push([1, 0, 4, 10, -24, 61]);
    // values[0].push([8, 0, -4, -8, 12, -7]);
    // values[0].push([1, 0, -1, -16, 14, 15]);
    // values[0].push([4, 0, 9, -8, 36, 76]);
    // values[0].push([2, 0, 1, -20, -2, 51]);
    // values[0].push([11, 0, -9, 66, 90, -126]);
    // values[0].push([1, 0, 1, -2, -16, 65]);///
    // values[0].push([9, 0, -25, 0, 50, -25]);//
    // values[0].push([1, 0, -9, -16, -36, 28]);
    // values[0].push([1, 0, -16, 14, -64, -15]);
    // values[0].push([1, 0, -5, 12, 30, -9]);
    // values[0].push([1, 0, 2, -6, 8, 33]);//--
    // values[0].push([1, 0, -9, -18, 0, 81]);
    // values[0].push([9, 0, 4, -54, -20, 106]);
    // values[0].push([1, 0, -1, -4, -10, -21]);
    // values[0].push([1, 0, -4, -10, -24, -11]);
    // values[0].push([9, 0, -4, -54, 8, 77]);
    // values[0].push([2, 0, 5, -8, 10, 33]);
    // values[0].push([4, 0, -1, 24, 10, 11]);//
    // values[0].push([16, 0, 4, -16, -12, 77]);
    // values[0].push([4, 0, -1, -4, 2, 0]);
    // values[0].push([9, 0, 9, -54, 54, 162]);///
    // values[0].push([1, 0, 2, 4, 12, 30]);//--
    // values[0].push([1, 0, -4, -4, 56, -192]);
    // values[0].push([4, 0, -1, -32, 6, 55]);
    // values[0].push([1, 0, 4, -10, -16, 81]);
    // values[0].push([1, 0, -6, -24, 120, -456]);
    // values[0].push([3, 0, 4, 30, 24, 135]);
    // values[0].push([2, 0, -1, -40, 18, 119]);
    // values[0].push([2, 0, 2, -20, 8, 66]);

    values[0].push([1, 0, 4, 10, -24, 61]);
    values[0].push([8, 0, -4, -8, 12, -7]);
    values[1].push([1, 0, -1, -16, 14, 15]);
    values[1].push([4, 0, 9, -8, 36, 76]);
    values[1].push([2, 0, 1, -20, -2, 51]);
    values[1].push([11, 0, -9, 66, 90, -126]);
    values[1].push([1, 0, 1, -2, -16, 65]);
    values[1].push([9, 0, -25, 0, 50, -25]);
    values[1].push([1, 0, -9, -16, -36, 28]);
    values[1].push([1, 0, -16, 14, -64, -15]);
    values[1].push([1, 0, -5, 12, 30, -9]);
    values[1].push([1, 0, 2, -6, 8, 33]);
    values[1].push([1, 0, -9, -18, 0, 81]);
    values[1].push([9, 0, 4, -54, -20, 106]);
    values[1].push([1, 0, -1, -4, -10, -21]);
    values[1].push([1, 0, -4, -10, -24, -11]);
    values[2].push([9, 0, -4, -54, 8, 77]);
    values[2].push([2, 0, 5, -8, 10, 33]);
    values[2].push([4, 0, -1, 24, 10, 11]);
    values[2].push([16, 0, 4, -16, -12, 77]);
    values[2].push([4, 0, -1, -4, 2, 0]);
    values[2].push([9, 0, 9, -54, 54, 162]);
    values[2].push([1, 0, 2, 4, 12, 30]);
    values[2].push([1, 0, -4, -4, 56, -192]);
    values[2].push([4, 0, -1, -32, 6, 55]);
    values[2].push([1, 0, 4, -10, -16, 81]);
    values[2].push([1, 0, -6, -24, 120, -456]);
    values[2].push([3, 0, 4, 30, 24, 135]);
    values[2].push([2, 0, -1, -40, 18, 119]);
    values[2].push([2, 0, 2, -20, 8, 66]);
